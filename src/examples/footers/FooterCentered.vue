    ...
    default: () => [
      {
        ...
        link: "https://www.facebook.com/lawuthailand",
      },
      {
        icon: '<i class="fab fa-line text-lg opacity-8"></i>',
        link: "https://line.me/ti/p/%40644ozljh",
      },
      // {
      ...
      <div class="row">
        <div class="col-8 mx-auto text-center mt-1">
          <p class="mb-0 text-secondary">
            <!-- Copyright © {{ new Date().getFullYear() }} LAW-U. -->
            Copyright © 2024 Center of Excellence in Medical Invention and Innovation (MEDII)
            <br>
            Thammasat School of Engineer, Thammasat University
          </p>
        </div>
      </div>
    </div>
